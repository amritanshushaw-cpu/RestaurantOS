...
class DynamicDatabaseEngine {
  ...
  initDefaultState() {
    ...
    const defaultMenuItems = [
      ...
      // --- DESSERTS & SWEETS ---
      { id: 'item-ind-09', category_id: 'cat-04', name: 'Gulab Jamun with Kesar', description: 'Warm soft milk dumplings soaked in rosewater, cardamom & saffron syrup', price: 160.00, is_available: true, image_url: 'https://images.unsplash.com/photo-1668236543090-82eba5ee5976?w=600&auto=format&fit=crop&q=80' },
