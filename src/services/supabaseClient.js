...
class DynamicDatabaseEngine {
  ...
  initDefaultState() {
    ...
    const defaultMenuItems = [
      ...
      { id: 'item-ind-20', category_id: 'cat-05', name: 'Royal Tandoori Mixed Grill', description: 'Platter of Murgh Tikka, Paneer Tikka, Seeking Kebab & Tandoori Prawns with mint chutney', price: 790.00, is_available: true, image_url: 'https://lookaside.fbsbx.com/lookaside/crawler/media/?media_id=1262626808652191' },
      ...
      { id: 'item-cont-10', category_id: 'cat-continental', name: 'French Onion Soup Gratinée', description: 'Rich caramelized onion broth topped with crusty baguette & melted Gruyère', price: 340.00, is_available: true, image_url: 'https://images.unsplash.com/photo-1583394838336-acd977736f90?w=600&auto=format&fit=crop&q=80' },
      ...
      { id: 'item-chin-08', category_id: 'cat-chinese', name: 'Hot & Sour Chicken Soup', description: 'Classic spicy & sour broth packed with chicken, bamboo shoots & mushrooms', price: 240.00, is_available: true, image_url: 'https://images.unsplash.com/photo-1547592180-85f173990554?w=600&auto=format&fit=crop&q=80' },
      { id: 'item-chin-09', category_id: 'cat-chinese', name: 'Crispy Veg Spring Rolls (4 pcs)', description: 'Golden pastry rolls filled with glass noodles & shredded vegetables with chili dip', price: 280.00, is_available: true, image_url: 'https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?w=600&auto=format&fit=crop&q=80' },
