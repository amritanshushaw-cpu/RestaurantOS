 ...
 * Two-step real verification: send code -> verify code.
 * Reuses existing .sentry-modal-overlay / .sentry-input-sm / .btn-sentry
 * classes already defined in src/styles/components.css -- no new visual
 * design introduced, only the fields this flow requires.
 */

import { authService } from '../services/authService.js';

export function openEmailAuthModal() {
    ...
    <div id="auth-modal" class="sentry-modal-overlay">
      <div class="sentry-modal-content google-auth-modal-card">
        <div class="google-modal-header">
          <div>
            <h3 class="google-modal-title">Sign in with Email</h3>
